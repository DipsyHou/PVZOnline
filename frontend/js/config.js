export const PLANT_CONFIGS = {
    ...
    iced_coconut: { name: '冰镇椰子', cost: 175, cooldown: 30, hp: 200, category: 'floating', img: 'assets/png/iced-coconut.png', desc: '滚动冰椰子，击退路径上的僵尸，到达终点后爆炸并减速僵尸。' },
    ...
    spiky_pumpkin: { name: '尖刺南瓜', cost: 150, cooldown: 30, hp: 2000, category: 'carrier', img: 'assets/svg/spiky-pumpkin.svg', desc: '可叠加在其他植物上提供保护。' },
    jalapeno_pair: { name: '火爆双椒', cost: 225, cooldown: 30, hp: 10000, category: 'normal', img: 'assets/svg/jalapeno-pair.svg', desc: '对一行一列的僵尸造成爆炸伤害。' },
    ...
    ninja_nut: { name: '忍者坚果', cost: 100, cooldown: 30, hp: 2000, category: 'normal', img: 'assets/png/ninja-nut.png', desc: '种下后会在周围召唤两个血量减半的坚果。' },
    ...
    christmas_nut: { name: '圣诞坚果', cost: 50, cooldown: 30, hp: 2000, category: 'normal', img: 'assets/png/christmas-nut.png', desc: '死亡时爆炸，造成3×3范围伤害。' },
